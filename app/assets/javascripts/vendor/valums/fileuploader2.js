...
Editor.prototype.fileDropped = function(e) {
  ...
  var drop = this.getDropPoint_(e);
  if (!drop) {
		this.uploader._uploadFileList(e.dataTransfer.files);
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                //'<div class="qq-upload-button">Drag and drop replay files or click here</div>' +
                '<ul class="qq-upload-list"></ul>' + 
             '</div>',

        // template for one item in file list
        fileTemplateReplay: '<li class="freplay">' +
            ...
            '</li>',
        fileTemplatePack: '<li class="fpack">' +
                '<span class="qq-upload-file"></span>' +
                '<span class="qq-upload-spinner"></span>' +
                '<span class="qq-upload-size"></span>' +
                //'<a class="qq-upload-cancel" href="#">Cancel</a>' +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _setupDragDrop: function(){
        ...
        qq.attach(document, 'dragleave', function(e){
            ...
            var relatedTarget = document.elementFromPoint(e.clientX, e.clientY);
						qq.setText(document.getElementById("console"), e.clientX + ", " + e.clientY + " " + e.pageX + ", " + e.pageY);
    ...
    _addToList: function(id, fileName){
        var item;
        if (fileName.match(/\.SC2Replay/i))
          var item = qq.toElement(this._options.fileTemplateReplay);
        else
          var item = qq.toElement(this._options.fileTemplatePack);
        item.qqFileId = id;
